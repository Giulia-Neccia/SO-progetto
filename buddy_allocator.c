...
void BuddyAllocator_initSingleBuffer(BuddyAllocator* b_allocator_,
  ...
  //bb minimum_bucket_size is no longer given as argument to the init function
  //bb compute it after having determined the memory available to the user
  ...
  //bb right shift operator = user_memory / pow(2, max_num_levels_)
  ...
  //ia total number of leaves (of size minimum_bucket_size)
